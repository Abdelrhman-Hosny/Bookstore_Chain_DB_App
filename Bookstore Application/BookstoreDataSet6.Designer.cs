...
namespace Bookstore_Application {
    ...
    public partial class BookstoreDataSet6 : global::System.Data.DataSet {
        ...
        public partial class AuthorsDataTable : global::System.Data.TypedTableBase<AuthorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AuthorsRow AddAuthorsRow(int Author_ID, string Fname, string LastName) {
        ...
        public partial class AuthorsRow : global::System.Data.DataRow {
            ...
            public string Fname {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Fname\' in table \'Authors\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsFnameNull() {
                return this.IsNull(this.tableAuthors.FnameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetFnameNull() {
                this[this.tableAuthors.FnameColumn] = global::System.Convert.DBNull;
            }
...
namespace Bookstore_Application.BookstoreDataSet6TableAdapters {
    ...
    public partial class AuthorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Authors] WHERE (([Author_ID] = @Original_Author_ID) AND ((@IsN" +
                "ull_Fname = 1 AND [Fname] IS NULL) OR ([Fname] = @Original_Fname)) AND ((@IsNull" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Authors] ([Author_ID], [Fname], [LastName]) VALUES (@Author_ID" +
                ", @Fname, @LastName);\r\nSELECT Author_ID, Fname, LastName FROM Authors WHERE (Aut" +
                "hor_ID = @Author_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Authors] SET [Author_ID] = @Author_ID, [Fname] = @Fname, [LastName] = @LastName WHERE (([Author_ID] = @Original_Author_ID) AND ((@IsNull_Fname = 1 AND [Fname] IS NULL) OR ([Fname] = @Original_Fname)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT Author_ID, Fname, LastName FROM Authors WHERE (Author_ID = @Author_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Author_ID, Fname, LastName FROM dbo.Authors";
        ...
        public virtual int Fill(BookstoreDataSet6.AuthorsDataTable dataTable) {
        ...
        public virtual BookstoreDataSet6.AuthorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookstoreDataSet6.AuthorsDataTable dataTable = new BookstoreDataSet6.AuthorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookstoreDataSet6.AuthorsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookstoreDataSet6 dataSet) {
        ...
        public virtual int Delete(int Original_Author_ID, string Original_Fname, string Original_LastName) {
        ...
        public virtual int Insert(int Author_ID, string Fname, string LastName) {
        ...
        public virtual int Update(int Author_ID, string Fname, string LastName, int Original_Author_ID, string Original_Fname, string Original_LastName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Fname, string LastName, int Original_Author_ID, string Original_Fname, string Original_LastName) {
            return this.Update(Original_Author_ID, Fname, LastName, Original_Author_ID, Original_Fname, Original_LastName);
        }
    }
